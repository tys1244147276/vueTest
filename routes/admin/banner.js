      ...
      collection.insertOne(
        ...
        (err, result) => {
          if (!err && result.result.ok) {
            ...
            res.send({ err: 0, msg: '成功', data: { id: result.insertedId, title, sub_title, banner, time, detail: { auth, content,icon} } })
            ...
            io.emit('banner_new',{ err: 0, msg: '成功', data: { id: result.insertedId, title, sub_title, banner, time, detail: { auth, content,icon } } })
